...
using Base = goby::zenoh::SingleThreadApplication<BasicSubscriberConfig>;
...
class BasicSubscriber : public Base
{
  public:
    ...
    BasicSubscriber()
    {
        ...
        //
        // Zenoh turns this into a subscription on the key expression for this group, scheme and
        // type, so that peers publishing anything else do not send it to this process at all
