...
int main(int argc, char* argv[])
{
    ...
    if (type == "remus")
    {
        goby::acomms::micromodem::protobuf::REMUSLBLParams* remus_params =
            cfg.MutableExtension(goby::acomms::micromodem::protobuf::config)->mutable_remus_lbl();
    ...
    else if (type == "narrowband")
    {
        ...
        goby::acomms::micromodem::protobuf::NarrowBandLBLParams* narrowband_params =
            cfg.MutableExtension(goby::acomms::micromodem::protobuf::config)
    ...
    request_msg.MutableExtension(goby::acomms::micromodem::protobuf::transmission)
        ->set_type((type == "remus")
