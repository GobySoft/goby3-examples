...
extern "C"
{
    ...
    frontseat_driver_load(goby::apps::moos::protobuf::iFrontSeatConfig*);
}

class AbcFrontSeat : public goby::moos::FrontSeatInterfaceBase
{
  public:
    AbcFrontSeat(const goby::apps::moos::protobuf::iFrontSeatConfig& cfg);
