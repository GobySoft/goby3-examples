...
namespace statechart
{
    ...
    template<typename App>
	struct Machine : boost::statechart::state_machine<Machine<App>, Off<App>>
    {
    public:
    ...
    template<typename App>
	struct On : boost::statechart::state<On<App>, Machine<App>>
    {
	...
	~On()
	{
	    std::cout << "Leaving state: ON" << std::endl;	    
	}
 	typedef boost::mpl::list<
	    boost::statechart::transition< EvTurnOff, Off<App> >
	    > reactions;
    };

    template<typename App>
	struct Off : boost::statechart::state<Off<App>, Machine<App>>
    {
	...
	~Off()
	{
	    std::cout << "Leaving state: OFF" << std::endl;
	}
	
 	typedef boost::mpl::list<
	    boost::statechart::transition< EvTurnOn, On<App> >
	    > reactions;
    };   
}
